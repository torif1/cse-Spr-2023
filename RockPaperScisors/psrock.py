...
def playoff(player1, player2, number_of_rounds=60):
    ...
    for round_number in range(number_of_rounds):
        move1, move2, new_score1, new_score2 = round(
            player1, player2, my_history1, my_history2)
...
def round_robin(number_of_rounds, *argv):
    ...
    for player1 in argv:
        ...
        for player2 in argv[argv.index(player1) + 1:]:
            ...
            score1 = str(score1[0]) + "-" + \
                str(score1[1]) + "-" + str(score1[2])
            score2 = str(score2[0]) + "-" + \
                str(score2[1]) + "-" + str(score2[2])

            report[player1_name] += "\n" + history1 + " " * 8 + player1_name + ": " + strategy_name(player1) + " " + score1 + "\n" + \
                                    history2 + " " * 8 + player2_name + \
                ": " + strategy_name(player2) + "\n"

            report[player2_name] += "\n" + history2 + " " * 8 + player2_name + ": " + strategy_name(player2) + " " + score2 + "\n" + \
                                    history1 + " " * 8 + player1_name + \
                ": " + strategy_name(player1) + "\n"
